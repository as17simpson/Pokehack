...
; Viridian Gym
	db $FF, 48, DUGTRIO, 53, NIDOQUEEN, 48, KANGASKHAN, 49, NIDOKING, 55, RHYDON, 60, GOLEM, 0
...
BrunoData:
	db $FF, 67, PRIMEAPE, 64, HITMONCHAN, 68, HITMONLEE, 62, ONIX, 65, MACHAMP, 70, POLIWRATH, 0
...
LtSurgeData:
	db $FF, 26, ELECTRODE, 23, JOLTEON, 24, RAICHU, 28, ELECTABUZZ, 0

ErikaData:
	db $FF, 29, VICTREEBEL, 30, TANGELA, 33, VILEPLUME, 34, EXEGGUTOR, 38, VENUSAUR, 0

KogaData:
	db $FF, 42, ARBOK, 39, MUK, 37, NIDOKING, 43, WEEZING, 47, NIDOQUEEN, 0

BlaineData:
	db $FF, 50, NINETALES, 49, RAPIDASH, 52, ARCANINE, 56, CHARIZARD, 55, FLAREON, 58, MAGMAR, 0

SabrinaData:
	db $FF, 48, SLOWBRO, 45, KADABRA, 44, MR_MIME, 50, ALAKAZAM, 52, MEW, 0
...
LanceData:
	db $FF, 72, GYARADOS, 68, DRAGONITE, 67, CHARIZARD, 70, AERODACTYL, 76, DRAGONITE, 0
