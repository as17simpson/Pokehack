...
INCLUDE "data/maps/headers/PalletTownCave.asm"
INCLUDE "scripts/PalletTownCave.asm"
INCLUDE "data/maps/objects/PalletTownCave.asm"
PalletTownCave_Blocks: INCBIN "maps/PalletTownCave.blk"
